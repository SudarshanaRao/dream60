  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8 max-w-5xl">
        <motion.div 
          className="bg-white border-l-4 border-purple-600 pl-6 sm:pl-12 pr-4 sm:pr-8 py-8"
        ...
        >
          {/* Title */}
          <div className="mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-purple-700 mb-2">PRIVACY POLICY</h1>
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Information provided by You</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
              ...
              <p className="text-sm sm:text-base mb-4">
                To avail certain services on our Portal, Users would be required to provide Personally Information for the registration and creation of your account on the Portal, which includes but is not limited to the following:
              </p>
            ...
            {/* Express Consent */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Express Consent</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Information automatically collected while using the app or website</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Usage */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Usage</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
              
              <p className="text-sm sm:text-base mb-4">
                <strong className="text-purple-700">For Registration:</strong> We will use the information including Personal Information provided by you to register you on our Portal and create an account that you can use to avail the Services
              </p>

              <p className="text-sm sm:text-base mb-4">
                <strong className="text-purple-700">For Providing Our Services:</strong> We will be using the information for the purpose of providing services, including but not limited to the following services requested by the User. Communicating through SMS, call and/or e-mail with you about the Service Keep you informed of the transaction status; send notification of any updates or changes in Services; allow our customer service to contact you, if necessary; customize the content of our Portal; validate/authenticate your account and to prevent any misuse or abuse. to contact you upon your request, or to respond to your query reach out to you about the services offered by our affiliates and our group entities to improve our Services
              </p>
            </div>

            {/* Marketing */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Marketing</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Advertising */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Advertising</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Information Sharing */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Information Sharing</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Information Security</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Log Files */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Log Files</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Links */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Links</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Confidentiality of your account</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Cookies */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Cookies</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Data Retention */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Data Retention</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Account and Data Deletion</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Disclaimer */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Disclaimer</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Condition of User */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Condition of User</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Accuracy and Updating Information</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
            ...
            {/* Contact Information */}
            <div className="mt-8">
              <h2 className="text-xl sm:text-2xl font-bold text-purple-700 mb-2">Contact Information</h2>
              <div className="h-0.5 w-24 bg-purple-600 mb-4"></div>
              
              <p className="text-sm sm:text-base mb-4">
                Any questions or clarifications with respect to this Privacy Policy or any complaints, comments, concerns or feedback can be sent to Dream60 at: support@dream60.com or by normal/physical mail addressed to:
              </p>

              <div className="text-sm sm:text-base ml-4">
            ...
            <div className="mt-8 pt-6 border-t border-gray-300">
              <p className="text-sm text-purple-600 font-semibold">Last updated: December 5, 2025</p>
            </div>
          </div>
        </motion.div>
      </main>
